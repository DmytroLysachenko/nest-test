...
API_LEGACY_SECRET_ENV_VARS="DATABASE_URL,ACCESS_TOKEN_SECRET,REFRESH_TOKEN_SECRET,MAIL_USERNAME,MAIL_PASSWORD,GOOGLE_OAUTH_CLIENT_SECRET,WORKER_AUTH_TOKEN,WORKER_CALLBACK_TOKEN,SCHEDULER_AUTH_TOKEN,OPS_INTERNAL_TOKEN"
