  ...
  return (
    <BaseButton
      ...
      className={cn(
        ...
        variant === 'default' &&
          'bg-primary text-primary-foreground hover:bg-primary/92 shadow-[0_12px_24px_-14px_color-mix(in_oklab,var(--primary)_72%,black)]',
        variant === 'secondary' &&
        ...
        variant === 'destructive' &&
          'bg-destructive text-destructive-foreground hover:bg-destructive/92 shadow-[0_12px_24px_-16px_color-mix(in_oklab,var(--destructive)_70%,black)]',
        className,
      )}
      {...props}
    />
