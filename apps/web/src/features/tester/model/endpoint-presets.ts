...
export const testerEndpointPresets: TesterEndpointPreset[] = [
  ...
  {
    id: 'ops-support-overview',
    label: 'Ops: support overview',
    service: 'api',
    method: 'GET',
    path: '/ops/support/overview',
    requiresAuth: true,
  },
  {
    id: 'ops-support-scrape-incident',
    label: 'Ops: scrape incident bundle',
    service: 'api',
    method: 'GET',
    path: '/ops/support/scrape-runs/<run-id>',
    requiresAuth: true,
  },
  {
    id: 'ops-support-user-incident',
    label: 'Ops: user incident bundle',
    service: 'api',
    method: 'GET',
    path: '/ops/support/users/<user-id>',
    requiresAuth: true,
  },
  {
    id: 'ops-support-correlation',
    label: 'Ops: correlate support artifacts',
    service: 'api',
    method: 'GET',
    path: '/ops/support/correlate?traceId=<trace-id>&requestId=<request-id>',
    requiresAuth: true,
  },
  {
    id: 'worker-health',
