...
export const EnvSchema = z.object({
  ...
  DOCUMENT_EXTRACTION_LEASE_MINUTES: z.coerce.number().int().min(1).max(240).default(15),
  CAREER_PROFILE_GENERATION_LEASE_MINUTES: z.coerce.number().int().min(1).max(240).default(15),
