        ...
        options: {
          ...
          onProgress: async ({ stage, meta }) => {
            const eventCodeByStage: Record<string, string> = {
              listing_http_fetch_started: 'LISTING_HTTP_FETCH_STARTED',
              listing_http_fetch_completed: 'LISTING_HTTP_FETCH_COMPLETED',
              listing_http_fetch_retry: 'LISTING_HTTP_FETCH_RETRY',
              listing_http_fetch_failed: 'LISTING_HTTP_FETCH_FAILED',
              listing_fallback_triggered: 'LISTING_FALLBACK_TRIGGERED',
              ...
              listing_browser_ready_timeout: 'LISTING_BROWSER_READY_TIMEOUT',
              detail_http_fetch_started: 'DETAIL_HTTP_FETCH_STARTED',
              detail_http_fetch_completed: 'DETAIL_HTTP_FETCH_COMPLETED',
              detail_http_fetch_failed: 'DETAIL_HTTP_FETCH_FAILED',
              detail_fallback_triggered: 'DETAIL_FALLBACK_TRIGGERED',
              detail_browser_navigation_started: 'DETAIL_BROWSER_NAVIGATION_STARTED',
              detail_browser_navigation_completed: 'DETAIL_BROWSER_NAVIGATION_COMPLETED',
              detail_browser_navigation_failed: 'DETAIL_BROWSER_NAVIGATION_FAILED',
            };
            const statusByStage: Record<string, 'info' | 'success' | 'warning' | 'failed'> = {
              listing_http_fetch_started: 'info',
              listing_http_fetch_completed: 'success',
              listing_http_fetch_retry: 'warning',
              listing_http_fetch_failed: 'failed',
              listing_fallback_triggered: 'warning',
              ...
              listing_browser_ready_timeout: 'warning',
              detail_http_fetch_started: 'info',
              detail_http_fetch_completed: 'success',
              detail_http_fetch_failed: 'warning',
              detail_fallback_triggered: 'warning',
              detail_browser_navigation_started: 'info',
