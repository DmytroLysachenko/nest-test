...
const ensureActiveCareerProfile = async (userId: string, profileInputId: string, fixture: FixtureUser) => {
  ...
  const [created] = await db
    ...
    .values({
      ...
      contentJson: {
        ...
        competencies: [
          ...
          },
          {
            ...
            confidenceLevel: 'high',
            importance: 'medium',
            evidence: ['Version control in team workflows'],
            yearsUsed: 5,
            recencyMonths: 0,
            isTransferable: false,
          },
          {
            ...
            confidenceLevel: 'high',
            importance: 'medium',
            evidence: ['Frontend integration with backend services'],
            yearsUsed: 4,
            recencyMonths: 0,
            isTransferable: true,
          },
        ...
        searchSignals: {
          keywords: [
            ...
            { value: 'frontend architecture', weight: 0.55 },
          ],
          specializations: [
            { value: 'frontend', weight: 1 },
      ...
      searchableTechnologies: ['react', 'typescript', 'node.js', 'javascript', 'html', 'git'],
