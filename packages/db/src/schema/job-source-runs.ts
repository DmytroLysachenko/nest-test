...
export const jobSourceRunsTable = pgTable(
  'job_source_runs',
  {
    ...
    classifiedOutcome: varchar('classified_outcome', { length: 64 }),
    emptyReason: varchar('empty_reason', { length: 64 }),
    sourceQuality: varchar('source_quality', { length: 32 }),
  ...
  (table) => ({
    ...
    traceIdIdx: index('job_source_runs_trace_id_idx').on(table.traceId),
