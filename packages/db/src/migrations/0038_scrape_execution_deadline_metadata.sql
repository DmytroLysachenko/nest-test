...
ALTER TABLE "scrape_execution_events"
ADD COLUMN "execution_status" varchar(32);

CREATE INDEX "scrape_execution_events_task_created_at_idx"
ON "scrape_execution_events" ("task_id", "created_at" DESC);

CREATE INDEX "scrape_execution_events_execution_status_created_at_idx"
ON "scrape_execution_events" ("execution_status", "created_at" DESC);

ALTER TABLE "job_source_runs"
ADD COLUMN "canonical_listing_url" text;

CREATE INDEX "job_source_runs_canonical_listing_url_idx"
